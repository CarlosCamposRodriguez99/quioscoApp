...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow md:p-6 md:mb-4 flex md:gap-10 gap-2 p-1 mb-2 items-center">
      ...
      <div>
        <button
          type="button"
          className="bg-sky-700 flex text-center md:px-2 md:py-2 px-1 p text-white rounded-md font-bold uppercase shadow-md w-full"
        >
          Editar
        </button>
        ...
        <button
          type="button"
          className="bg-red-700 flex px-2 py-2 text-white rounded-md font-bold uppercase shadow-md w-full mt-5"
        >
          Eliminar
        </button>
      </div>
