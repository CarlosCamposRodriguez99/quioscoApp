...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow md:p-3 md:mb-3 lg:flex md:flex-1 flex-1 md:gap-6 p-4 mb-6 items-center">
      <div className="md:w-2/3 lg:w-full w-full">
        <Image 
          width={300}
          height={400}
      ...
      <div className="flex">
        <button
          type="button"
          className="bg-sky-700 flex gap-4 md:px-2 md:py-2 px-1 py-1 text-white rounded-md font-bold uppercase shadow-md w-full"
        >
