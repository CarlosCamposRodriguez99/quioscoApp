...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow md:p-2 md:mb-8 lg:p-0 lg:flex md:flex-1 flex-1 md:gap-2 p-4 mb-4 items-center">
      <div className="md:w-full md:flex justify-center md:m-0 lg:w-1/5 w-full">
        <Image 
          width={300}
          height={400}
