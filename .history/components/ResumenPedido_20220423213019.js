...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow md:p-6 md:mb-4 flex md:gap-10 gap-4 p-6 mb-4 items-center">
      ...
      <div>
        <button
          type="button"
          className="bg-sky-700 flex px-2 py-2 text-white rounded-md font-bold uppercase shadow-md md:w-full w-4/6 lg:w-auto"
        >
          Editar
        </button>
      </div>
