...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow p-6 mb-4 flex md:gap-10 gap-5 m-4 items-center">
      ...
      <div className="md:w-5/6">
        ...
        <p className="md:text-3xl text-1xl text-center font-bold mt-2">Subtotal: {formatearDinero(producto.precio * producto.cantidad)}</p>
