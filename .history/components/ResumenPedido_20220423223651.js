  ...
  return (
    <div className="shadow md:p-6 md:mb-4 flex md:gap-10 gap-2 px-1 py-1 w-full mb-2 items-center">
      ...
      <div>
        <button
          type="button"
          className="bg-sky-700 flex text-center md:px-2 md:py-2 px-auto py-auto text-white rounded-md font-bold uppercase shadow-md w-full"
        >
          Editar
        </button>
        ...
        <button
          type="button"
          className="bg-red-700 flex md:px-2 md:py-2 px-0 py-0 text-white rounded-md font-bold uppercase shadow-md w-full mt-3"
        >
          Eliminar
        </button>
      </div>
