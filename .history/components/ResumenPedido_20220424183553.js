  ...
  return (
    <div className="shadow md:p-4 md:mb-8 lg:p-1 lg:flex md:flex-1 flex-1 md:gap-2 p-4 mb-4 items-center">
      ...
      <div className="flex">
        <button
          type="button"
          className="bg-sky-700 flex md:gap-10 md:flex-1 lg:gap-1 gap-4 text-center md:px-3 md:py-3 px-1 py-1 text-white rounded-md font-bold uppercase shadow-md w-full"
        >
