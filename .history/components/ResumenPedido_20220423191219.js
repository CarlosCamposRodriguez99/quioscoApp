...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow p-5 mb-4 flex gap-10 items-center">
      ...
      <div className="md:w-5/6">
        ...
        <p className="md:text-3xl text-1xl text-center font-bold text-amber-500 mt-2">Subtotal:{formatearDinero(producto.precio * producto.cantidad)}</p>
