...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow md:p-6 md:mb-4 flex md:gap-10 gap-4 p-auto mb-4 justify-space-between w-full lg:w-auto items-center">
      ...
      <div>
        <button
          type="button"
          className="bg-sky-700 flex md:px-5 md:py-2 px-4 py-2 text-white rounded-md font-bold uppercase shadow-md w-full lg:w-auto"
        >
          Editar
        </button>
      </div>
