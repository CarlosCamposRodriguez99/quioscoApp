...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow md:p-1 md:py-4 md:justify-center md:mb-6 md:mx-6 lg:flex md:flex-1 flex-1 md:gap-2 p-4 mb-6 items-center">
      <div className="md:w-3/5 lg:w-1/5 w-full">
        <Image 
          width={300}
          height={400}
