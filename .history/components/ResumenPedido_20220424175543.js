...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow md:p-4 md:mb-8 lg:p-0 lg:flex md:flex-1 flex-1 md:gap-2 p-4 mb-4 items-center">
      ...
      <div className="md:w-full md:flex-1 lg:w-1/2 w-full">
        <p className="md:text-2x2 text-2xl text-center font-bold">{producto.nombre}</p>
