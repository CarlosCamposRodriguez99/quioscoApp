...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow md:p-16 md:m-4 lg:p-1 lg:flex md:flex-1 flex-1 md:gap-2 p-4 mb-4 items-center">
      ...
      <div className="flex">
        ...
        <button
          type="button"
          className="bg-red-700 flex md:gap-4 lg:gap-1 gap-2 md:px-2 md:py-2 px-1 py-1 text-white rounded-md font-bold uppercase shadow-md w-full mx-1"
        >
