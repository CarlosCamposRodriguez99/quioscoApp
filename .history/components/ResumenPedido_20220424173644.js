...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow md:p-2 md:mb-6 lg:p-0 lg:flex md:flex-1 flex-1 md:gap-2 p-4 mb-4 items-center">
      ...
      <div className="flex">
        <button
          type="button"
          className="bg-sky-700 flex md:gap-8 lg:gap-1 gap-3 text-center md:px-3 md:py-3 px-1 py-1 text-white rounded-md font-bold uppercase shadow-md w-full"
        >
