...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow md:p-16 md:mx-4 md:my-4 lg:p-1 lg:flex md:flex-1 flex-1 md:gap-2 p-4 mb-4 items-center">
      <div className="md:w-full md:p-auto lg:w-1/5 w-full">
        <Image 
          width={300}
          height={400}
      ...
      <div className="flex">
        <button
          type="button"
          className="bg-sky-700 flex md:gap-4 lg:gap-1 gap-3 text-center md:px-3 md:py-3 px-1 py-1 text-white rounded-md font-bold uppercase shadow-md w-full"
        >
        ...
        <button
          type="button"
          className="bg-red-700 flex md:gap-3 lg:gap-1 gap-2 md:px-3 md:py-3 px-1 py-1 text-white rounded-md font-bold uppercase shadow-md w-full mx-1"
        >
