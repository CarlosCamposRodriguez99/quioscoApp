...
const ModalProducto = () => {
  ...
  return (
    <div className="md:flex gap-10">
      <div className="md:w-2/3 md:p-0 p-3">
        <Image 
          height={400}
          width={300}
      ...
      <div className="md:w-2/3">
        <div className="flex justify-end">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-9 w-8" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="flex justify-center">
          <button
            type="button"
            className="bg-indigo-600 hover:bg-indigo-800 px-5 py-2 mt-5 text-white font-bold uppercase mb-5 cursor-pointer rounded"
