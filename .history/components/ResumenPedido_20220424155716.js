...
const ResumenPedido = ({producto}) => {
  return (
    <div className="shadow md:p-3 md:mb-3 md:flex flex-1 md:gap-6 px-1 py-2 mb-2 items-center">
      <div className="md:w-2/3 md:flex-1 w-full">
        <Image 
          width={300}
          height={400}
      ...
      <div className="flex">
        <button
          type="button"
          className="bg-sky-700 flex gap-3 md:px-2 md:py-2 px-1 py-1 text-white rounded-md font-bold uppercase shadow-md w-full"
        >
